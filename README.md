...
[Live Demo](https://sahakar-seva-opal.vercel.app/) • [Architecture](#technology-stack) • [Matching Formula](#the-matching-formula) • [Run Instructions](#-quick-start--run-instructions)
